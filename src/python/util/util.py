...
class Util:
    ...
    @staticmethod
    def get_formatted_report(raw_report: Dict,dot_path, num_data=1000) -> Dict[str, Any]:
        """
        ...
        for report_key in raw_report['reports'].keys():
            ...
            for th_key in report['th_results'].keys():
                ...
                Util.calc_worse_throughput(vertexes, dot_path, new_th_placement_distances,num_data)
    ...
    @staticmethod
    def calc_worse_th_by_dot_file(dot_path, dot_name,num_data= 1000):
        # print(f'DOT: {dot_name}')
        per_graph = PeRGraph(dot_path, dot_name)
        df_simul = DfSimulSw(per_graph,num_data)
    ...
    def calc_worse_throughput(vertexes,path_file, edges_dist,num_data = 1000):
        ...
        G = nx.drawing.nx_pydot.read_dot(path_file)
        ...
        return Util.calc_worse_th_by_dot_file(dot_path,dot_name,num_data)
